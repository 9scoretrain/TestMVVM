...
enum MoviesAPI {
  ...
  //  private static let apiKey = "efb6cac7ab6a05e4522f6b4d1ad0fa43"
    private static let apiKey = "8fd6920fbc4eb9841dfd261f3cb91aca"
    private static let agent = Agent()
    private static let exampleURL: String  =
    "https://api.themoviedb.org/3/movie/550?api_key=8fd6920fbc4eb9841dfd261f3cb91aca"
